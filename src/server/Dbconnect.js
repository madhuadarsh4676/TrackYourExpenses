...
//       return res
//         .status(400)
//         .send("Invalid data: category and positive amount required");
//     }
...
// app.get("/api/expenses/sum", async (req, res) => {
//   try {
//     // Query all expenses
//     const expenses = await Expense.find();
...
//     const { name, bankName, accountNumber, amount, accountType } = req.body;
...
// app.get("/api/bank-accounts/amount", async (req, res) => {
//   try {
//     // Aggregate pipeline to calculate the sum of all amounts
//     const totalAmount = await BankAccount.aggregate([
//       {
//         $group: {
//           _id: null,
...
//     // Respond with the total sum of amounts
//     res.json({ total });
//   } catch (error) {
